...
(function () {
  ...
  EV.input = function (miso) {
    ...
    var html = '<div style="font-size:16px;font-weight:800;margin-bottom:4px">' + esc(miso) + ' 평가' + (locked ? ' <span style="font-size:11px;color:#16a34a">🔒 완료</span>' : '') + '</div>'
      ...
      // 근태서류 지연·미제출 감점
      + '<tr style="background:#fdf4ff"><td class="l">근태서류 제출<div style="font-size:10px;color:#93a">지연 ' + (ctx.formLateN || 0) + '건 · 미제출 ' + (ctx.formMissN || 0) + '건<br>기한(요청+3일) 초과 −1 / 미제출 −3</div></td>'
